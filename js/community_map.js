...
var color = d3.scale.category20();
    d3.json("../Dataset/la_community.json", function (data) {
        d3.json("../Dataset/la_community_map.json", function (error, root) {
            if (error)
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                var dataName = data[i].Community_Name;
                ...
                for (var j = 0; j < root.features.length; j++) {
                    if (root.features[j].properties.community_name) {
                        var geoName = root.features[j].properties.community_name;
                        if (dataName == geoName) {
